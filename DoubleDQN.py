...
def train(net, tarnet, start):
    ...
    for iteration in range(net.num_iterations):
        ...
        if iteration % 25000 == 0:
            torch.save(net, "DoubleDQNmodel_weights/current_model_" + str(iteration) + ".pth")
        ...
        if terminal:
            ...
            if (meant>300) & (t>600):
                ...
                np.save('finalresults/DoubleDQNfinal.npy',[iteration,time.time() - start])
                save_durations(net.episode_durations)
                torch.save(net, "DoubleDQNmodel_weights/final_model.pth")
                break
...
def save_durations(episode_durations):
    ...
    np.save("duration/DoubleDQNduration.npy", durations_t.numpy())
...
if __name__ == "__main__":
    ...
    if mode == 'test':
        model = torch.load(
            ...
            'DoubleDQNmodel_weights/final_model.pth',
        ...
        if not os.path.exists('DoubleDQNmodel_weights/'):
            os.mkdir('DoubleDQNmodel_weights/')
